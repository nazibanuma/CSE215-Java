...
public class NowShowingFrame extends javax.swing.JInternalFrame {
    ...
    public NowShowingFrame() {
        ...
        NowShowingScrollPane.setHorizontalScrollBarPolicy(javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
    ...
    private void showMovieDetails(final String[] p) {
        // Expected indices (if you saved all 12 fields):
        ...
        final javax.swing.JDialog d = new javax.swing.JDialog(owner, "Movie Details", java.awt.Dialog.ModalityType.APPLICATION_MODAL);
        ...
        if (master != null) {
            poster.setIcon(new javax.swing.ImageIcon(master.getScaledInstance(pw, ph, java.awt.Image.SCALE_SMOOTH)));
        }
        poster.setBorder(javax.swing.BorderFactory.createEmptyBorder(10, 10, 10, 10));
        d.add(poster, java.awt.BorderLayout.WEST);

        // CENTER: info (simple labels + synopsis)
        ...
        javax.swing.JButton showtimesBtn = new javax.swing.JButton("Showtimes");
        javax.swing.JButton buyBtn = new javax.swing.JButton("Buy Tickets");
        buttons.add(showtimesBtn);
        buttons.add(buyBtn);
        d.add(buttons, java.awt.BorderLayout.SOUTH);

        // Very basic actions (replace with your real navigation)
        showtimesBtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent e) {
                d.dispose();
                String title = safe(p, 0);

                // create the ShowTime internal frame with preselected movie
                theatre2.dashboard.MainPageFrames.ShowTime st
                        = new theatre2.dashboard.MainPageFrames.ShowTime(title);

                // add it to the same desktop pane this frame is in
                ...
                if (dp != null) {
                    ...
                    // If this JInternalFrame isn't inside a JDesktopPane, just show a message.
                    javax.swing.JOptionPane.showMessageDialog(
                            NowShowingFrame.this,
                            "ShowTime screen needs a JDesktopPane container."
                    );
                }
            }
        });
        buyBtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent e) {
                d.dispose();
                java.awt.Window w = javax.swing.SwingUtilities.getWindowAncestor(NowShowingFrame.this);
                if (w instanceof theatre2.dashboard.MainPage) {
                    theatre2.dashboard.MainPage mp = (theatre2.dashboard.MainPage) w;
                    mp.openBuyTicketForMovie(safe(p, 0));  // pass title
                } else {
                    javax.swing.JOptionPane.showMessageDialog(
                            NowShowingFrame.this,
                            "Go to Buy Tickets for: " + safe(p, 0));
                }
            }
        });
